...
module.exports = {
    ...
    register(receivedMessage, callback) {
        ...
        user({'_id' : "<@!" + receivedMessage.author.id +">", '_server': "PWP", '_season': "1", '_name' : receivedMessage.author.username, '_currentDeck': "None", '_elo' : 1000, '_wins' : 0, '_losses' : 0, '_deck': [[]]}).save(function(err, result){
            if(result){
