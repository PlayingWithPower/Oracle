...
module.exports = {
    ...
    const user = require('../Schema/Users')
        user({'_id' : "<@!" + receivedMessage.author.id +">", '_server': "PWP", '_season': "1", '_name' : receivedMessage.author.username, '_currentDeck': "None", '_elo' : 1000, '_wins' : 0, '_losses' : 0}).save(function(err, result){
            if(result){
